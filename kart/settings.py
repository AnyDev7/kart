...
ALLOWED_HOSTS = ['anydev7.shop', 'www.anydev7.shop', '127.0.0.1']
...
COMPANY_BANN4 = config('COMPANY_BANN4')
COMPANY_BANN5 = config('COMPANY_BANN5')
COMPANY_BANN1_ALT = config('COMPANY_BANN1_ALT')
COMPANY_BANN2_ALT = config('COMPANY_BANN2_ALT')
COMPANY_BANN3_ALT = config('COMPANY_BANN3_ALT')
COMPANY_BANN4_ALT = config('COMPANY_BANN4_ALT')
COMPANY_BANN5_ALT = config('COMPANY_BANN5_ALT')
